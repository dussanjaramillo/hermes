...
<head>
    ...
    <title>Hermes | Sustitución Vigenere </title>
    ...
    <script src="js/sustitucionvigenere.js"></script>
    <script src="js/sustitucionvigenere_rollBack.js"></script>
</head>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Sustitución Vigenere</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="inicio.php">Inicio</a></li>
                            <li class="breadcrumb-item active">Sustitución Vigenere</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label>Clave</label>
                                                <input type="text" class="form-control" placeholder="Clave" id="clave2">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <!-- textarea -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                            <div class="card-header">
                                <h3 class="card-title">Sustitución Vigenere</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <p>El cifrado Vigenère es un cifrado basado en diferentes series de caracteres o letras del cifrado César formando estos caracteres una tabla, llamada tabla de Vigenère, que se usa como clave. El cifrado de Vigenère es un cifrado de sustitución simple polialfabético.</p>
                                            ...
                                            <p>Este cifrado es conocido porque es fácil de entender e implementar, además parece irresoluble; esto le hizo valedor del apodo el código indescifrable (le chiffre indéchiffrable, en francés).</p>
                                            <pre>
                                            ...
                                            <p>En este alfabeto solo existen 27 letras:</p>
                                            ...
                                            <p><img src="img/Cuadro_Vigenere.png" alt="Cuadro Vigènere con las 27 letras del español" width="50%" align="center" ></p>

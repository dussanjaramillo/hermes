...
<head>
    ...
    <title>Hermes | Trasnsposición </title>
    ...
    <script src="js/transposicion.js"></script>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Transposición</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a class="btn btn-app" href="#" id="matriz2">
                                        <i class="fas fa-cubes"></i> Ver matriz
                                    </a>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card card-danger">
                            ...
                            <form role="form">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a class="btn btn-app" href="#" id="matriz3">
                                        <i class="fas fa-cubes"></i> Ver matriz
                                    </a>
                                </div>
                            </form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                            <div class="card-header">
                                <h3 class="card-title">Transposición</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form">
